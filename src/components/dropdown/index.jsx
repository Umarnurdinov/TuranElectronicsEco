    ...
    <div id="filter">
      <div className="container">
        <div className="filter">
          <div className="filter--all">
            <div onMouseEnter={hoverOption} className="filter--all__select">
              <div>
                <div className="logo__content">
                  ...
                  <p className="logoname">{data.name}</p>
                  {down ? (
                    <FaAngleUp className="selectUp" />
                  ) : (
                    <FaAngleDown className="selectDown" />
                  )}
                </div>
              </div>
              <div
                onMouseLeave={hoverOption2}
                ref={refOption}
                className="filter--all__select--option"
              >
            ...
            <div
              onMouseEnter={hoverOptionModel}
              className="filter--all__select"
            >
              <h4>
                Модель
                {downM ? (
              ...
              <div
                onMouseLeave={hoverOptionModel2}
                ref={refOptionModel}
            ...
            >
              ...
              <div
                onMouseLeave={hoverOptionPrice2}
                ref={refOptionPrice}
            ...
            >
              ...
              <div
                onMouseLeave={hoverOptionColor2}
                ref={refOptionColor}
      ...
      <div ref={refClose} className="filterAll">
        <div className="filterAll--card">
          <h1>
            Фильтры{" "}
            <IoClose onClick={clickClose} className="filterAll--card__close" />
          </h1>
          <div onClick={clickOptionPrice} className="filterAll--card__select">
            ...
            <div
              ref={refAllOptionPrice}
              className="filterAll--card__select--optionPrice"
            >
          ...
          <div onClick={clickOptionModel} className="filterAll--card__select">
            ...
            <div
              ref={refAllOptionModel}
              className="filterAll--card__select--optionModel"
            >
          ...
          <div onClick={clickOptionObem} className="filterAll--card__select">
            ...
            <div
              ref={refAllOptionObem}
              className="filterAll--card__select--optionObem"
            >
          ...
          <div onClick={clickOptionColor} className="filterAll--card__select">
            ...
            <div
              ref={refAllOptionColor}
              className="filterAll--card__select--optionColor"
            >
