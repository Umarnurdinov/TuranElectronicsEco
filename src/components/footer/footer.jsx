                    ...
                    <div className="footer__content">
                        <div className="footer__info">
                            ...
                            <div className="footer__info__texts">
                                <p className="footer__info__text">
                                    Turan Electronics - ваш идеальный магазин
                                    для шопинга. Обнаружьте <br /> последние
                                    тренды, выбирайте изысканные товары,
                                    оформляйте заказы с <br /> легкостью.
                                    Элегантный дизайн, безопасные платежи и
                                    быстрая доставка - <br /> все, что вам нужно
                                    для приятного онлайн-шопинга. <br /> <br />
                        ...
                        <div className="footer__title">
                                ...
                                <div className="contacts__text">
                                    <div className="footer__geo">
                                        ...
                                        <p className="footer__geo__text">
                                            ...
                                            ул.Киевская 168, 720001
                                        </p>
                                    </div>
                                    <div className="footer__map">
                                        <img src={map} alt="#" />
                                        <p className="footer__map__text">
                                            Работаем каждый день с 10:00 <br />{" "}
                                            до 20:00
                                        </p>
                                    </div>
                            ...
                            <div className="information">
                                <h1 className="information__logo">
                                    ИНФОРМАЦИЯ
                                </h1>
                                <h1 className="line"></h1>
                                ...
                                <div className="information__texts">
                                    ...
                                    <p className="information__aboutUs">
                                        О Нас
                                    </p>
                                    <p className="information__varanty">
                                        Условия гарантии
                                    </p>
                                    <p className="information__credit">
                                        Условия кредитования
                                    </p>
                                    <p className="information__delivery">
                                        Доставка
                                    </p>
                                    <p className="information__privacy">
                                        Политика конфиденциальности
                                    </p>
                                    <p className="information__public">
                                        Публичная оферта
                                    </p>
                                    <p className="information__contacts">
                                        Контакты
                                    </p>
                                </div>
                            </div>
                            <div className="personalArea">
                                <h1 className="personalArea__logo">
                                    Личный Кабинет
                                </h1>
                                <h1 className="line"></h1>
                                <div className="peronalArea__texts">
                                    <p className="personalArea__personal">
                                        Личный Кабинет
                                    </p>
                                    <p className="personalArea__history">
                                        История заказов
                                    </p>
                                    <p className="personalArea__bookmarks">
                                        Закладки
                                    </p>
                                    <p className="personalArea__compare">
                                        Сравнить
                                    </p>
                                    <p className="personalArea__newsletter">
                                        Рассылка
                                    </p>
                                    <p className="personalArea__siteMap">
                                        Карта сайта
                                    </p>
                                    <p className="personalArea__manufacturers">
                                        Производители
                                    </p>
                                </div>
                            </div>
